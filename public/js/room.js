...
let whiteboardOpen = false; // Tambahkan variabel global untuk melacak status whiteboard

function toggleWhiteboard() {
    const whiteboard = document.querySelector('.whiteboard-cont');
    const boardIcon = document.getElementById('boardIcon');
    const backIcon = document.getElementById('backIcon');

    whiteboardOpen = !whiteboardOpen; // Toggle status whiteboard
    ...
    if (whiteboardOpen) {
        ...
        boardIcon.style.display = 'inline-block';
